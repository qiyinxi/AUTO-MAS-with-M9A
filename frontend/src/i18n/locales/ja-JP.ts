...
export default {
  ...
  edit: {
    ...
    bettergiTeamOffTip:
      'パーティー設定はオフです：表のデータは保持されますが、共通パーティー以外は選出に参加しません。',
    bettergiTeamAdd: 'パーティーを追加',
    bettergiTeamEditTitle: 'パーティーを編集',
    bettergiTeamBatchDelete: '一括削除',
    bettergiTeamOpenStrategyDir: 'ストラテジーフォルダを開く',
    bettergiTeamAdvanced: '詳細設定',
    bettergiTeamDragTip:
      '左側のハンドルをドラッグして並び替えできます。0 行目の共通パーティーは先頭に固定されます',
    bettergiTeamIndexColumn: '番号',
    bettergiTeamNameColumn: 'パーティー名',
    bettergiTeamStrategyColumn: '戦闘ストラテジー',
    bettergiTeamScenesColumn: '戦闘シーン',
    bettergiTeamNoteColumn: 'メモ',
    ...
    bettergiTeamEdit: '編集',
    bettergiTeamDuplicate: '複製',
    bettergiTeamDelete: '削除',
    bettergiTeamEmpty: 'パーティーがありません。「パーティーを追加」から設定してください',
    bettergiTeamStrategyTip:
      '空欄の場合は「共通戦闘ストラテジー」に従います。入力した場合はシーン一致時にこのストラテジーを使用します',
    bettergiTeamSceneTip:
      'タブをまたいで複数の条件を設定できます。条件が 1 つもないパーティーは選出に参加しません',
    bettergiTeamSceneDomainTab: '自動秘境',
    bettergiTeamSceneLeylineTab: '自動地脈の花',
    bettergiTeamSceneBossTab: '自動ボス討伐',
    bettergiTeamSceneRegion: '地域',
    bettergiTeamSceneDomain: '秘境',
    bettergiTeamSceneReward: '報酬アイテム（表示のみ）',
    bettergiTeamSceneCountry: '地域',
    bettergiTeamSceneLeylineType: '地脈タイプ',
    bettergiTeamSceneBoss: 'ボス',
    bettergiTeamSceneAddDomain: '秘境条件を追加',
    bettergiTeamSceneAddLeyline: '地脈条件を追加',
    bettergiTeamSceneAddBoss: 'ボス条件を追加',
    bettergiTeamSceneDialogTip:
      'マッチングは完全一致です。今回の実行対象と完全に同じパーティーだけが選ばれます。',
    bettergiTeamNameRequired: 'パーティー名を入力してください',
    bettergiTeamNameExists: '同名のパーティーが既に存在します',
